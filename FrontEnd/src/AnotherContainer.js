    ...
    return (
      <React.Fragment>
          <Box sx={{ opacity:'100%',backgroundImage:"url(/heroFinal2.png)", paddingBottom:16, paddingLeft:100, paddingTop:19, marginTop:-6}}>
            ...
            <Link to="/addexpense"  ><Button  sx={{backgroundColor:'blue', width:'400px', color:'white', marginBottom:2 }}>Record Expense</Button></Link><br></br>
    ...
    return (
      <React.Fragment>
          <Box sx={{ opacity:'100%',backgroundImage:"url(/heroFinal2.png)", paddingBottom:16, paddingLeft:100, paddingTop:19, marginTop:-6}}>
            ...
            <Link to="/login"  ><Button  sx={{backgroundColor:'purple', width:'400px', color:'white', marginBottom:2 }}>Login</Button></Link><br></br>
            <Link to="/about"><Button sx={{backgroundColor:'purple', width:'400px', color:'white', marginBottom:2 }}>What is Super Budget?</Button></Link><br></br>
          </Box>
      </React.Fragment>
    );
